...
samples = ['QCD','GluGluHToZZTo2L2Q_MAll'] #'GluGluHToZZTo2L2Q_M1000','GluGluHToZZTo2L2Q_M1500','GluGluHToZZTo2L2Q_M2000','GluGluHToZZTo2L2Q_M2500','GluGluHToZZTo2L2Q_M3000']#['ZZ','DYJets','WZ']
...
outfilename = "../RawHistos/DeepAK8VarAll_noptbins.root"
...
for sample in samples:
    histos[sample]={}
    histos[sample]['tau1_notZero_pt'] = TH1D(sample+'_tau1_notZero_pt',sample+'_tau1_notZero_pt',135,200,3000)
    ...
    for var_name in var_names:
        histos[sample][var_name]=TH1D(sample+"_"+var_name,sample+"_"+var_name,100,0,1)
...
for sample in samples:
    ...
    for ievent,event in enumerate(tempTree):
        ...
        if(sample!='QCD'): histos[sample]['Z1_mass'].Fill(massZ1)
