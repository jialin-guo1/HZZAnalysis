...
var_tau1 = ['SDmass_SR','SDmass_CR','Pt','eta','Z1_mass','Z1_pt','Hmass','dR_lep','dR_ZZ','weight','eventWeight','pileupWeight','genWeight']
...
for sample in samples:
    ...
    for ievent,event in enumerate(tempTree):
        ...
        if(passedMergedJetSRSelection):
            ...
            histos[sample]['Z1_pt'].Fill(leptonic_Z.Pt(),weight)
            ...
            histos[sample]['dR_ZZ'].Fill(deltaR_ZZ)
