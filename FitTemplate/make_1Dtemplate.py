        ...
        for reg in regions:
            ...
            for tag in tags:
                ...
                for sam in ['TTplusWW','VZ',]:
                    ...
                    histo[sam] = bh.Histogram(bh.axis.Regular(bins=60, start=500, stop=3500),storage=bh.storage.Weight())
                for sample in config['Samples_lists']:
                    ...
                    if sample!='Data':
                        ...
                        temp_hist = bh.Histogram(bh.axis.Regular(bins=60, start=500, stop=3500),storage=bh.storage.Weight())
