...
def print_cutflow_histogram():
    file = ROOT.TFile("/cms/user/guojl/Sample/2L2Q/UL_Legacy/2018/MC/ggh/skimed/GluGluHToZZTo2L2Q_M300_TuneCP5_13TeV_powheg2_JHUGenV7011_pythia8__v16_L1v1-v1_0.root")  
    cutflow = file.Get("cutflow")

    #file = ROOT.TFile("/cms/user/guojl/Sample/2L2Q/UL_Legacy/2018/MC/WZTo2Q2L_mllmin4p0_TuneCP5_13TeV-amcatnloFXFX-pythia8/skimed/WZTo2Q2L.root") 
    #tmp_h = file.Get("cutflow") 
    #cutflow.Add(tmp_h)
#
    #file = ROOT.TFile("/cms/user/guojl/Sample/2L2Q/UL_Legacy/2018/MC/WWTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/skimed/WWTo2L2Nu.root") 
    #tmp_h = file.Get("cutflow") 
    #cutflow.Add(tmp_h)
